...
import com.example.weatherappui.ui.theme.ColorTextAction
import com.example.weatherappui.ui.theme.ColorTextPrimary
import com.example.weatherappui.ui.theme.ColorTextPrimaryVariant
import com.example.weatherappui.ui.theme.ColorTextSecondary
import com.example.weatherappui.ui.theme.ColorTextSecondaryVariant
import com.example.weatherappui.utils.fromHex
...
fun AirQualityIndicator(
    value: String, color: String, modifier: Modifier = Modifier,
) {
    Surface(
        modifier = modifier,
...
@Composable
fun WeekForecastHeader(modifier: Modifier = Modifier) {
    Row(
        modifier = modifier.fillMaxWidth(),
...
@Composable
fun ActionText(modifier: Modifier = Modifier) {
    Row(
        modifier = modifier,
        verticalAlignment = Alignment.CenterVertically,
